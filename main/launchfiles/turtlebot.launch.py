...
MODEL_PACKAGE = "main"
MODEL_NAME = "turtlebot4.urdf.xacro"
...
def generate_launch_description():
    ...
    # get Paths
    model_file = os.path.join(package_model, "turtlebot4_description", "urdf", "standard", MODEL_NAME)
    ...
    params = {"robot_description": model_file, "use_sim_time": use_sim_time}
